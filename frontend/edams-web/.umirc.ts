...
export default defineConfig({
  ...
  proxy: {
    ...
    '/auth': {
      target: process.env.AUTH_BASE_URL || 'http://localhost:8081',
      changeOrigin: true,
      secure: false,
    },
  },
      ...
      routes: [
        ...
        },
        {
          ...
          routes: [
            ...
            { path: '/quality/sla', component: 'sla', name: 'SLA监控' },
          ],
        },
        {
          path: '/standards',
          ...
          routes: [
            { path: '/standards/list', component: 'standard', name: '标准管理' },
          ],
        },
        {
          path: '/sandbox',
          ...
          routes: [
            { path: '/sandbox/list', component: 'sandbox', name: '沙箱列表' },
          ],
        },
        {
          path: '/rules',
          ...
          routes: [
            { path: '/rules/manage', component: 'rules', name: '规则管理' },
          ],
        },
        {
          path: '/chatbot',
          ...
          icon: 'RobotOutlined',
          routes: [
            { path: '/chatbot/index', component: 'chatbot', name: 'AI助手' },
          ],
        },
        {
          path: '/aiops',
