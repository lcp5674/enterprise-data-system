...
export const API_PATHS = {
  // SSO相关
  SSO: {
    LOGIN: '/auth/api/v1/sso/login',
    CALLBACK: '/auth/api/v1/sso/callback',
    USERINFO: '/auth/api/v1/sso/userinfo',
    LOGOUT: '/auth/api/v1/sso/logout',
    REFRESH: '/auth/api/v1/sso/refresh',
    VALIDATE: '/auth/api/v1/sso/validate',
    REALMS: '/auth/api/v1/sso/realms',
    HEALTH: '/auth/api/v1/sso/health',
  },
